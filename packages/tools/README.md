...
All action should pass through the dispatcher when logging, credentials,
anonymization, rate limits, argument scrubbing, or safety checks matter. Direct
adapter calls make audit events and safety surprises easy to skip.
