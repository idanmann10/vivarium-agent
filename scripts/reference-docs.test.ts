...
describe("reference docs", () => {
  ...
  test("documents the current Mac install handoff audit", () => {
    ...
    for (const term of [
      ...
      "`606 pass, 0 fail, 5247 expect calls`",
      "build a simple agent end to end",
      "run-1779287522117-447",
      ...
      "vivarium 0.0.0",
      "runs `354`",
      "latest run `build a simple agent end to end (success, score 0.8)`",
      ...
      "head `bbcd69823a28e5d8f03ca4c239beedf9a82e2838`",
      "Operator Handoff",
