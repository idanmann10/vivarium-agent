...
describe("createDaemonFetchHandler", () => {
  test("serves a human-readable dashboard at the daemon root", async () => {
    ...
    expect(body).toContain("Template Reference");
    expect(body).toContain("TailAdmin Next.js shell with shadcn dashboard blocks.");
    expect(body).toContain("Agent Roster");
    expect(body).toContain("Agent Directory");
    ...
    expect(body).toContain("Live Workspace");
    expect(body).toContain("Agent World");
    expect(body).toContain("Quick Chat");
    expect(body).toContain("Activity Lanes");
    expect(body).toContain('data-testid="live-workspace"');
    ...
    expect(body).toContain('data-world-canvas="ops"');
    expect(body).toContain('<form id="gateway-quick-chat-form">');
    expect(body).toContain('bindRunForm(document.getElementById("gateway-quick-chat-form"))');
    expect(body).toContain("function drawOpsWorld(");
    expect(body).toContain("requestAnimationFrame(drawOpsWorld)");
    ...
    expect(body).toContain('data-testid="chat-session-cards"');
