...
Before a Railway deployment exists, the design needs:
...
Do not treat Railway as live-ready until those decisions are implemented and
tested. Use `docs/guides/deploy-local-compose.md` for the current daemon
verification path.
