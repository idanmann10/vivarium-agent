...
| Phase 3 multi-world subscriptions | Multi-world retrieval tests cover skills and published runs with source labels; local-reader tests cover proposed anti-pattern, trace, and run discovery used by the same search path | Complete locally |
