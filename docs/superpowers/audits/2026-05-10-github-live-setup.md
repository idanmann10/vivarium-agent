...
| Current work is published to GitHub | `the-agent` `phase-1-runtime-slice` and `main` include live doctor URL validation commit `ce950ff`; `the-world` `phase-3-world-integration-slice` and `main` point at `6df8516` | Complete |
...
| Agent CI is green | `https://github.com/idanmann10/vivarium-agent/actions/runs/25643528842` completed with `conclusion: success` on `main` | Complete |
