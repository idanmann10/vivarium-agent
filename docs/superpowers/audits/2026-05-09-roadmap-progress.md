...
- `bun run test`: 165 tests passed, 0 failed.
...
- `bun test packages/tools/src/builtin/self-tools.test.ts apps/cli/src/commands/world.test.ts apps/cli/src/dispatcher.test.ts apps/cli/src/commands/run.test.ts`: 31 tests passed, including builtin world subscription self-tools, CLI subscription registry commands, saved-subscription search, and run-level subscription routing.
