...
- `the-agent` world regression-reporting self-tool implemented after metadata self-tools, recording local anti-pattern candidates and opening injected GitHub regression issues when configured.
...
- `bun test packages/world/src/pull.test.ts apps/cli/src/commands/world.test.ts apps/cli/src/dispatcher.test.ts`: 26 tests passed, including local second-install world transmission verification and repeated-root CLI search routing.
- `bun test packages/tools/src/builtin/self-tools.test.ts packages/world/src/write.test.ts packages/world/src/local-reader.test.ts packages/runtime/src/orchestrator.test.ts apps/cli/src/commands/run.test.ts`: 30 tests passed, including builtin world subscription, proposal, run-publish, and trace-publish self-tools, visibility-aware proposal writing, local proposal retrieval, runtime publishable run queueing, and run-level subscription routing.
...
- `bun test packages/tools/src/builtin/self-tools.test.ts packages/world/src/github.test.ts apps/cli/src/commands/github.test.ts packages/runtime/src/orchestrator.test.ts`: 27 tests passed, including world regression-reporting self-tools, mocked GitHub issue creation, guarded GitHub commands, and runtime orchestration.
