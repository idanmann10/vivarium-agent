...
- `bun run test`: 166 tests passed, 0 failed.
...
- `bun test packages/tools/src/builtin/self-tools.test.ts packages/world/src/write.test.ts apps/cli/src/commands/world.test.ts apps/cli/src/dispatcher.test.ts apps/cli/src/commands/run.test.ts`: 39 tests passed, including builtin world subscription and proposal self-tools, visibility-aware proposal routing, CLI subscription registry commands, saved-subscription search, and run-level subscription routing.
