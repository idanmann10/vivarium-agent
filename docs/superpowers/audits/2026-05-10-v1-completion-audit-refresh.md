...
- `bun run test` in `the-agent`: 243 tests passed, 0 failed, 1273 assertions.
...
- `bun test apps/cli/src/commands/doctor.test.ts`: 31 tests passed, 0 failed, 148 assertions.
