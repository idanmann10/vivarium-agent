...
- `bun run test` in `the-agent`: 250 tests passed, 0 failed, 1300 assertions.
...
- `bun test apps/cli/src/commands/doctor.test.ts`: 38 tests passed, 0 failed, 175 assertions.
