...
- `bun run test` in `the-agent`: 239 tests passed, 0 failed, 1255 assertions.
...
- `bun test apps/cli/src/commands/doctor.test.ts`: 27 tests passed, 0 failed, 130 assertions.
