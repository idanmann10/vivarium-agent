...
- `bun run test` in `the-agent`: 233 tests passed, 0 failed, 1232 assertions.
...
- `bun test apps/cli/src/commands/doctor.test.ts`: 21 tests passed, 0 failed, 107 assertions.
