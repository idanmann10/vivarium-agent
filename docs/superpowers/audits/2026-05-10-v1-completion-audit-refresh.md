...
- `bun run test` in `the-agent`: 251 tests passed, 0 failed, 1304 assertions.
...
- `bun test apps/cli/src/commands/doctor.test.ts`: 39 tests passed, 0 failed, 179 assertions.
