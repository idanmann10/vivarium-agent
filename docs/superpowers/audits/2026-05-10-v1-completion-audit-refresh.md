...
- `bun run test` in `the-agent`: 248 tests passed, 0 failed, 1293 assertions.
...
- `bun test apps/cli/src/commands/doctor.test.ts`: 36 tests passed, 0 failed, 168 assertions.
