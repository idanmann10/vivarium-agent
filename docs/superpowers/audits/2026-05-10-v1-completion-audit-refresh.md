...
- `bun run test` in `the-agent`: 240 tests passed, 0 failed, 1258 assertions.
...
- `bun test apps/cli/src/commands/doctor.test.ts`: 28 tests passed, 0 failed, 133 assertions.
