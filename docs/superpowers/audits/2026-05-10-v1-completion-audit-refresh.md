...
- `bun run test` in `the-agent`: 236 tests passed, 0 failed, 1241 assertions.
...
- `bun test apps/cli/src/commands/doctor.test.ts`: 24 tests passed, 0 failed, 116 assertions.
