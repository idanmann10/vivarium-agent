...
- `bun run test` in `the-agent`: 238 tests passed, 0 failed, 1252 assertions.
...
- `bun test apps/cli/src/commands/doctor.test.ts`: 26 tests passed, 0 failed, 127 assertions.
