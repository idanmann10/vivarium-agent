...
- `bun run test` in `the-agent`: 237 tests passed, 0 failed, 1249 assertions.
...
- `bun test apps/cli/src/commands/doctor.test.ts`: 25 tests passed, 0 failed, 124 assertions.
