...
- `bun run test` in `the-agent`: 242 tests passed, 0 failed, 1265 assertions.
...
- `bun test apps/cli/src/commands/doctor.test.ts`: 30 tests passed, 0 failed, 140 assertions.
