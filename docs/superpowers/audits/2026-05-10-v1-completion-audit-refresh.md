...
- `bun run test` in `the-agent`: 253 tests passed, 0 failed, 1312 assertions.
...
- `bun test apps/cli/src/commands/doctor.test.ts`: 41 tests passed, 0 failed, 187 assertions.
