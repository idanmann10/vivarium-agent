...
- `bun run test` in `the-agent`: 245 tests passed, 0 failed, 1281 assertions.
...
- `bun test apps/cli/src/commands/doctor.test.ts`: 33 tests passed, 0 failed, 156 assertions.
