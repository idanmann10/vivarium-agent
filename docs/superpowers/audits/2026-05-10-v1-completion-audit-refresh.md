...
- `bun run test` in `the-agent`: 247 tests passed, 0 failed, 1289 assertions.
...
- `bun test apps/cli/src/commands/doctor.test.ts`: 35 tests passed, 0 failed, 164 assertions.
