...
- `bun run test` in `the-agent`: 246 tests passed, 0 failed, 1285 assertions.
...
- `bun test apps/cli/src/commands/doctor.test.ts`: 34 tests passed, 0 failed, 160 assertions.
