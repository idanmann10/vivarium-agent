...
- `bun run test` in `the-agent`: 244 tests passed, 0 failed, 1277 assertions.
...
- `bun test apps/cli/src/commands/doctor.test.ts`: 32 tests passed, 0 failed, 152 assertions.
