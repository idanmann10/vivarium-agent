...
- `bun run test` in `the-agent`: 252 tests passed, 0 failed, 1308 assertions.
...
- `bun test apps/cli/src/commands/doctor.test.ts`: 40 tests passed, 0 failed, 183 assertions.
