...
- `bun run test` in `the-agent`: 249 tests passed, 0 failed, 1296 assertions.
...
- `bun test apps/cli/src/commands/doctor.test.ts`: 37 tests passed, 0 failed, 171 assertions.
