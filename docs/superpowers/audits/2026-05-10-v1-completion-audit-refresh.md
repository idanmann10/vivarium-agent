...
- `bun run test` in `the-agent`: 236 tests passed, 0 failed, 1242 assertions.
...
- `bun test apps/cli/src/commands/doctor.test.ts`: 24 tests passed, 0 failed, 117 assertions.
