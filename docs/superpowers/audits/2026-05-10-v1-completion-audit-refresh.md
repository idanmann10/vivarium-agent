...
- `bun run test` in `the-agent`: 241 tests passed, 0 failed, 1261 assertions.
...
- `bun test apps/cli/src/commands/doctor.test.ts`: 29 tests passed, 0 failed, 136 assertions.
